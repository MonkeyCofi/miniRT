...
/*   Updated: 2024/10/19 20:03:40 by pipolint         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	cylinder = create_cylinder(return_tuple(0, 0, 0, POINT));
//	origin = return_tuple(0.5, 0, -5, POINT);
//	direction = return_tuple(0.1, 1, 1, VECTOR);
//	normalize(&direction);
//	ray = create_ray(origin, direction);
//	intersects = ft_calloc(1, sizeof(t_intersects));
//	cylinder_hit(NULL, intersects, ray, cylinder);
//	printf("Number of intersects: %d\n", intersects->intersection_count);
//	print_intersects(intersects);
//	normal = normal_pos_cylinder(cylinder, return_tuple(-1, 1, -1, POINT));
//	printf("Normal: ");
