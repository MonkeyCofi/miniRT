...
/*   Updated: 2024/12/04 19:17:12 by pipolint         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minirt.h"

static void	bottom(t_intersects *intersects, t_ray *ray, t_disc *s, \
	t_shape *shape)
{
	t_cylinder	*cyl;
	double		t_bottom;
...
static void	body(t_intersects *intersects, t_ray *ray, t_disc *s, \
	t_shape *shape)
{
	int			i;
	t_cylinder	*cyl;
